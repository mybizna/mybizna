<template>
    <table-edit :path_param="path_param" :model="model">
        <div class="row">
            ...
            <div class="col-md-6">
                <FormKit label="buying" id="buying" type="text" validation="required" />
                <FormKit label="selling" id="selling" type="text" validation="required" />
                <FormKit label="Published" id="published" type="switch" validation="required" />
                <FormKit label="Is Fetched" id="is_fetched" type="switch" validation="required" />
