            ...
            <div class="col-md-6">
                ...
                <div class="border border-gray rounded p-2 mb-2">
                    ...
                    <FormKit label="Left Ledger" id="left_ledger_id" type="recordselect"  v-model="model.left_ledger_id"
                        comp_url="ledger/recordselect?type=left&ledger_id=" :filter="model.left_chart_of_account_id" validation="required" />
                </div>
                <div class="border border-gray rounded p-2 mb-2">
                    ...
                    <FormKit label="Right Ledger" id="right_ledger_id" type="recordselect"  v-model="model.right_ledger_id"
                        comp_url="ledger/recordselect?type=right&ledger_id=" :filter="model.right_chart_of_account_id" validation="required" />
                </div>
            </div>
            <div class="col-md-6">
                <FormKit label="Description" id="description" type="textarea" v-model="model.description" validation="required"  />
                <FormKit label="Type" id="type" type="select" v-model="model.type" validation="required" />
                <FormKit label="Is Processed" id="is_processed" type="switch" v-model="model.is_processed" validation="required" />
            </div>
        </div>
