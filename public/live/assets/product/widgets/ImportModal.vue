                        ...
                        >
                            ...
                            >
                                <div
                                    ...
                                    id="erp-csv-import-error"
                                >
                                    <ul
                                        class="erp-list"
                                        v-if="isObject(errors)"
                                    >
                                        <li
                                ...
                                <div
                                    ...
                                    id="erp-import-processing"
                                >
                                    <span
                                        v-if="isWorking"
                                        class="erp-loader"
                                    ></span>
                                    <span v-if="isWorking" class="loading-text"
                                        >{{ workingText }}...</span
                                    >
                                </div>
...
export default {
    ...
    methods: {
        importCsv() {
            ...
            window.axios
                .post("products/csv/validate", formData, {
                    headers: {
                        "Content-Type":
                            "multipart/form-data;" +
                            "boundary=" +
        ...
        showImportError(error) {
            ...
            document
                .getElementById("erp-import-modal-body")
...
.import-processing .loading-text {
    margin-left: 50px;
    font-size: 28px;
    font-weight: 200;
    line-height: 1.1;
