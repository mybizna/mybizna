<template>
    <div class="sales-tax-report">
        ...
        <list-table
            tableClass="table table-sm table-striped widefat sales-tax-table sales-tax-table-customer"
            :columns="columns"
            :rows="taxes"
            :showCb="false"
        >
...
@media screen and (max-width: 782px) {
    .sales-tax-table-customer thead th .column.trn_date,
    .sales-tax-table-customer thead th .column.tax_amount {
        display: none;
    }

    .sales-tax-table-customer tfoot tr.tfoot td:first-child {
