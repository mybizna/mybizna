<template>
    <div class="sales-tax-report">
        ...
        <list-table
            tableClass="table table-sm table-striped widefat sales-tax-table sales-tax-table-category"
            :columns="columns"
            :rows="taxes"
            :showCb="false"
        >
...
export default {
    components: {
        ...
        MultiSelect:window.$func.fetchComponent('components/select/DatepiMultiSelectcker.vue'),
    },
