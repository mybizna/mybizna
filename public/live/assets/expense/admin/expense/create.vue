<template>
    <div class="container expense-create">
        <!-- Start .header-section -->
        <div class="content-header-section separator">
            <div class="row between-xs">
                <div class="col">
                    <h2 v-if="draftToExpense()">
                        {{ this.$func.__("Convert into Expense", "erp") }}
                    </h2>
                    <h2 v-else class="content-header__title">
                        {{ this.$func.__("New Expense", "erp") }}
                    </h2>
                </div>
            </div>
        </div>
...
export default {
    ...
    data() {
        return {
            ...
            accts_by_chart: [],
            erp_acct_assets:
                this.$erp_acct_var.acct_assets /* global this.$erp_acct_var */,
        };
    },
    ...
    methods: {
        ...
        updateExpense(requestData) {
            window.axios
                ...
                .then((res) => {
                    var message = this.$func.__("Expense Updated!", "erp");
        ...
        createExpense(requestData) {
            window.axios
                ...
                .then((res) => {
                    this.showAlert(
                        "success",
                        this.$func.__("Expense Created!", "erp")
                    );
                    this.$router.push({ name: "Expenses" });
                })
                .catch((error) => {
