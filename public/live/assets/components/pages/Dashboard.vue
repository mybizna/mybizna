...
import MiniStatistic from '@/components/common/widgets/statistic/MiniStatistic';
import PostListCard from '@/components/common/widgets/card/PostListCard';
import ProfileCard from '@/components/common/widgets/card/ProfileCard';
import PostSingleCard from '@/components/common/widgets/card/PostSingleCard';
import WeatherCard from '@/components/common/widgets/card/WeatherCard';
import PlainTable from '@/components/common/widgets/list/PlainTable';
import PlainTableOrder from '@/components/common/widgets/list/PlainTableOrder';
import VWidget from '@/components/common/VWidget';
import Material from 'vuetify/es5/util/colors';
import VCircle from '@/components/common/circle/VCircle';
import BoxChart from '@/components/common/widgets/chart/BoxChart';
import ChatWindow from '@/components/common/chat/ChatWindow';
import CircleStatistic from '@/components/common/widgets/statistic/CircleStatistic';
import LinearStatistic from '@/components/common/widgets/statistic/LinearStatistic';
export default {
  components: {
    VWidget,
    MiniStatistic,
