        ...
        <v-row>
                ...
                <v-card class="d-flex align-center">
                    ...
                    >
                        ...
                        <div>
                            ...
                            <v-card-text>
                                Apple iPhone 11 Pro smartphone. Announced Sep
                                2019. Features 5.8″ display Apple A13 Bionic
                            </v-card-text>
                    ...
                    <div class="d-flex flex-column-reverse flex-md-row">
                        <div>
                            ...
                            <v-card-text>
                                ...
                                there were coffee houses, because how are you
                                supposed to build.
                            </v-card-text>
                            <v-card-actions class="dense">
                                <v-btn text color="primary" dark>
                    ...
                    <v-row class="ma-0 h-full">
                        ...
                        >
                            ...
                            <v-card-text>
                                ...
                                thought such as Coca Cola, body muscles and
                                holding ones own breath. Though, most of these
                                notes are not fundamentally necessary, they are
                                such that you can use them for a good laugh, at
                                a drinks party or for picking up women or men.
                            </v-card-text>
                            <v-card-text>
                                <v-divider></v-divider>
                            </v-card-text>
                        ...
                        >
                            <div class="membership-pricing">
                                ...
                                <v-btn color="primary" class="mt-6">
                                    Contact Now
                                </v-btn>
                            </div>
                        </v-col>
            ...
            <v-col cols="12" lg="4" md="6">
                <v-card>
                    <v-card-title>Influencing The Influencer</v-card-title>
                    <v-card-text>
                        Computers have become ubiquitous in almost every facet
                        of our lives. At work, desk jockeys spend hours in front
                        of their desktops, while delivery people scan bar codes
                        with handhelds and workers in the field stay in touch.
                    </v-card-text>
                    <v-card-text>
                        If you’re in the market for new desktops, notebooks, or
                        PDAs, there are a myriad of choices. Here’s a rundown of
                        some of the best systems available.
                    </v-card-text>
                    <v-card-text>
                        The following non-standard attributes are available on
                        some browsers.
                    </v-card-text>
                    <v-card-actions class="dense">
            ...
            <v-col cols="12" md="6" lg="4">
                <v-card>
                    ...
                    <v-card-text>
                        ...
                        business that won’t cost you more money, maybe printing
                        is one of the options you won’t resist. Printing is a
                        widely use process in making printed materials that are
