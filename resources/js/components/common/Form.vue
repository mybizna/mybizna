                    ...
                    <div :class="row.class">
                        ...
                        <template v-for="(field, findex)  in row.fields" :key="findex">
                            ...
                            <CheckboxElement v-else-if="field.html == 'checkbox'" :name="field.name" :items="field.options"
                                :label="field.label" :id="field.name" :placeholder="field.label"
                                :description="field.description" :info="field.info" />

                            <CheckboxgroupElement v-else-if="field.html == 'checkboxgroup'" :name="field.name"
                                :items="field.options" :label="field.label" :id="field.name" :placeholder="field.label"
                                :description="field.description" :info="field.info" />
                            ...
                            <TagsElement v-else-if="field.html == 'tags'" :name="field.name" :label="field.label"
                                :items="field.options" :id="field.name" :placeholder="field.label"
                                :description="field.description" :info="field.info" />
                            ...
                            <RecordpickerElement v-else-if="field.html == 'recordpicker'" :name="field.name"
                                ...
                                :placeholder="field.label" :description="field.description" :info="field.info"
