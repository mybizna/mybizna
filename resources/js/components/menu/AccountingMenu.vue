...
div.erp-nav-container .erp-page-header .page-title {
    font-size: 20px;
    line-height: 1.4em;
    font-weight: 700;
    margin: 0;
...
div.erp-nav-container li a:after {
    content: "\f347";
    display: inline-block;
    padding-left: 5px;
}

div.erp-nav-container li:hover i,
div.erp-nav-container li.active i {
    color: #1a9ed4;
}

div.erp-nav-container li:hover .erp-nav-dropdown {
    display: block;
}

div.erp-nav-container li i {
    position: absolute;
    right: -2px;
    top: 50%;
    color: inherit;
...
div.erp-nav-container .-primary > li {
    /*flex-grow: 1;*/
}
...
div.erp-nav-container .-primary .-more {
    margin: 13px 0;
}
...
div.erp-nav-container .-secondary > li {
    /*padding: 3px 15px;*/
}
