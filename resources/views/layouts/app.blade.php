...
<head>
    ...
    <script>
        ...
        function this.$func.__(title, select){
            return title;
        }
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                ...
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse"
                    ...
                    aria-expanded="false" aria-label="{{ this.$func.__('Toggle navigation') }}">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @if (Route::has('login'))
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('login') }}">{{ this.$func.__('Login') }}</a>
                        </li>
                        @endif

                        @if (Route::has('register'))
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('register') }}">{{ this.$func.__('Register') }}</a>
                        </li>
                        @endif
                        @else
