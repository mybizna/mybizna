            ...
            <div class="flex">
                <div v-if="sidebar_show" class="flex-none w-56 border-r border-gray-100 shadow-lg bg-white z-2">
                    <ul class="sidebar-menu tree" data-widget="tree">
                        <li class="header">Important Apps</li>
                        ...
                        <li class="treeview">
                            <a href="#">
                                <i class="text-sm fas fa-rocket"></i>
                                <span>Subscribe</span>
                            </a>
                        </li>
                        <li class="treeview">
                            <a href="#">
                                <i class="text-sm fas fa-phone"></i>
                                <span>Buy Airtime</span>
                            </a>
                        </li>
                        <li class="treeview">
                            <a href="#">
                                <i class="text-sm fas fa-dollar-sign"></i>
                                <span>Add Fund</span>
                            </a>
                        </li>
                        <li class="treeview">
                        ...
                        <li class="treeview">
                            <a href="#">
                                <i class="text-sm fas fa-network-wired"></i>
                                <span>Downline</span>
                            </a>
                        </li>

                        <li class="treeview  menu-open">
                            <a @click="team_menu = !team_menu" class="cursor-pointer">
                                <i class="fas fa-users-cog"> </i>
                                
                                <span>Team Detail</span>
                                <span class="pull-right-container">
                                    <i class="text-xs fa fa-angle-right pull-right"></i>
                                </span>
                            </a>
                            <ul class="treeview-menu" :class="!team_menu ? 'hidden' : 'block'">
                                <li>
                                    <a href="#">
                        ...
                        <li class="treeview">
                            <a href="#">
                                <i class="text-sm fas fa-funnel-dollar"></i>
                                <span>Transactions</span>
                            </a>
                        </li>
                        <li class="treeview">
                            <a href="#">
                                <i class="text-sm fas fa-hand-holding-usd"></i>
                                <span>Withdrawal</span>
                            </a>
                        </li>
                        <li class="treeview">
                            <a href="#">
                                <i class="text-sm fas fa-receipt"></i>
                                <span>Payments</span>
                            </a>
                        </li>
                        <li class="treeview">
                            <a @click="history_menu = !history_menu" class="cursor-pointer">
                            ...
                            <ul class="treeview-menu" :class="!history_menu ? 'hidden' : 'block'">
                                <li>
                                    <a href="#">
                                        <i class="text-xs fas fa-circle"></i>
