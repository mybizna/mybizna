    ...
    methods: {
        async prepareDataLoad() {
            ...
            if (this.$route.params.id) {
                ...
                if (!request2.data.bill_details.length) {
                    this.showAlert("error", window.$func.__("Bill does not exists!", "erp"));
                    return;
                }
                ...
                if (!canEdit) {
                    this.showAlert("error", window.$func.__("Can't edit", "erp"));
                    return;
                }
        ...
        updateBill(requestData) {
            window.axios
                ...
                .then((res) => {
                    this.showAlert("success", window.$func.__("Bill Updated!", "erp"));
                })
                .catch((error) => {
                    throw error;
                })
        ...
        createBill(requestData) {
            window.axios
                ...
                .then((res) => {
                    this.showAlert("success", window.$func.__("Bill Created!", "erp"));
                })
                .catch((error) => {
                    throw error;
                })
