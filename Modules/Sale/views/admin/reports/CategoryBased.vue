<template>
    <div class="sales-tax-report">
        <h2 class="title-container">
            <span>{{ window.$func.__("Sales Tax Report (Category Based)", "erp") }}</span>
        ...
        <ul class="report-header" v-if="null !== taxCategory">
            <li>
                <strong>{{ window.$func.__("Category Name", "erp") }}:</strong>
    ...
    data() {
        return {
            ...
            columns: {
                ...
                trn_date: { label: window.$func.__("Transaction Date", "erp") },
                tax_amount: { label: window.$func.__("Tax Amount", "erp") },
            },
