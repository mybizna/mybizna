            ...
            <div class="mybizna-row mybizna-between-xs">
                <div class="mybizna-col">
                    <h2 v-if="draftToExpense()">
                        {{ window.$func.__("Convert into Expense", "erp") }}
                    </h2>
                    <h2 v-else class="content-header__title">
                        {{ window.$func.__("New Expense", "erp") }}
                    </h2>
                </div>
            </div>
        </div>
                    ...
                    <form action="" class="mybizna-form" method="post">
                        <div class="mybizna-row">
                            ...
                            <div class="mybizna-col-sm-4">
                                <div class="mybizna-form-group">
                                    <label
                                        >{{ window.$func.__("Expense Date", "erp")
                            ...
                            <div class="mybizna-col-sm-4 with-multiselect">
                                <label
                                    >{{ window.$func.__("Transaction From", "erp")
                                    }}<span class="mybizna-required-sign"
                                        >*</span
                                    ></label
                                >
                    ...
                    <table class="mybizna-table mybizna-form-table">
                        <thead>
                            <tr class="inline-edit-row">
                                ...
                                <th scope="col">{{ window.$func.__("Account", "erp") }}</th>
                                <th scope="col">
                                    {{ window.$func.__("Description", "erp") }}
                                </th>
    ...
    methods: {
        ...
        updateExpense(requestData) {
            window.axios
                ...
                .then((res) => {
                    ...
                    var message = window.$func.__("Expense Updated!", "erp");
        ...
        createExpense(requestData) {
            window.axios
                ...
                .then((res) => {
                    this.showAlert("success", window.$func.__("Expense Created!", "erp"));
                    this.$router.push({ name: "Expenses" });
                })
                .catch((error) => {
                    throw error;
        ...
        validateForm() {
            ...
            if (
                ...
                this.form_errors.push(
                    window.$func.__("Transaction Account is required.", "erp")
                );
            }
