...
export default {
    components: {
        ...
        PeopleTransaction: window.$func.fetchComponent(
            "components/people/PeopleTransaction.vue"
        ),
    },
    ...
    methods: {
        ...
        getTransactions() {
            window.axios
                .get("/employees/" + this.userId + "/transactions")
                .then((res) => {
        ...
        filterTransaction(filters = {}) {
            window.axios
                .get("/employees/" + this.userId + "/transactions/filter", {
                    params: {
        ...
        getChartData(filters = {}) {
            window.axios
                .get(`/transactions/people-chart/trn-amount/${this.userId}`, {
                    params: {
                        start_date: filters.start_date,
                        end_date: filters.end_date,
                    },
            ...
            window.axios
                .get(`/transactions/people-chart/trn-status/${this.userId}`, {
                    params: {
                        start_date: filters.start_date,
                        end_date: filters.end_date,
                    },
