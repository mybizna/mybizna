<template>
    <div class="app-customers single-tax-rate">
        ...
        <div class="table-container">
            <list-table
                tableClass="wp-ListTable table-sm widefat fixed tax-rate-list table table-striped"
...
.single-tax-rate th.column.actions {
    float: left !important;
}
@media (min-width: 783px) {
    .single-tax-rate .product-list .col--actions {
        float: left !important;
    }
    .single-tax-rate .product-list .row-actions {
