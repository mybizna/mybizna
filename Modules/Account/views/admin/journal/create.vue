...
export default {
    ...
    methods: {
        ...
        calculateAmount(key) {
            ...
            this.debit_total = this.debitLine.reduce(
                (a, b) => parseFloat(a) + parseFloat(b),
                0
            );
            this.credit_total = this.creditLine.reduce(
                (a, b) => parseFloat(a) + parseFloat(b),
                0
            );
        ...
        totalDebit() {
            this.debit_total = this.debitLine
        ...
        totalCredit() {
            this.credit_total = this.creditLine
                .reduce((a, b) => parseFloat(a) + parseFloat(b), 0)
                .toFixed(2);
...
<style>
.journal-create input[type="text"] {
    width: 90%;
}

.journal-create .dropdown {
    width: 100%;
}

.journal-create .col--account {
    width: 300px;
}

.journal-create .col--particulars {
    width: 400px;
}
</style>
