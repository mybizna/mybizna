        ...
        <div class="content-header-section separator">
            <div class="mybizna-row mybizna-between-xs">
                <div class="mybizna-col">
                    <h2 class="content-header__title">{{ window.$func.__('Dashboard', 'erp') }}</h2>
                    <a class="mybizna-btn btn--primary" :href="tutorialUrl" id="btn-tutorial-start">
                        <span class="dashicons dashicons-controls-play"></span>
                        {{ window.$func.__(' Start Tutorial', 'erp') }}
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="mybizna-dashboard">
            ...
            <div class="mybizna-row">
                    ...
                    <div class="mybizna-col-sm-6 mybizna-col-xs-12 ">
                        ...
                        <div class="invoice-own-section mybizna-panel mybizna-panel-default">
                            <div class="mybizna-panel-heading mybizna-bg-white">
                                <h4>{{ window.$func.__('Bills you need to pay', 'erp') }}</h4>
                            </div>
                            <div class="mybizna-panel-body pb-0">
...
export default {
    ...
    data() {
        return {
            title1        : window.$func.__('Income & Expenses', 'erp'),
            title2        : window.$func.__('Bank Accounts', 'erp'),
            title3        : window.$func.__('Invoices owed to you', 'erp'),
            title4        : window.$func.__('Bills to pay', 'erp'),
            closable      : true,
            msg           : window.$func.__('Accounting', 'erp'),
            to_receive    : [],
            to_pay        : [],
