<template>
    <div class="container check-create">
        <!-- Start .header-section -->
        <div class="content-header-section separator">
            <div class="row between-xs">
                <div class="col">
                    <h2 class="content-header__title">
                        {{ this.$func.__("New Check", "erp") }}
                    </h2>
                </div>
            </div>
        </div>
                            ...
                            >
                                ...
                                >
                                    <input
                                        ...
                                        class="text-right form-control form-contro-sm form-field"
                                        :required="
 ...
 emits: {
    ...
    methods: {
        async prepareDataLoad() {
            ...
            if (this.$route.params.id) {
                ...
                const request2 = await window.axios.get(
                    `/expenses/checks/${this.$route.params.id}`
                );

                if (!request2.data.bill_details.length) {
                    this.showAlert(
                        "error",
                        this.$func.__("Check does not exists!", "erp")
                    );
                    return;
                }
        ...
        getBanks() {
            ...
            window.axios
                .get(`/ledgers/${bank_chart_id}/accounts`)
                .then((response) => {
        ...
        updateCheck(requestData) {
            window.axios
                ...
                .then((res) => {
                    this.showAlert("success", this.$func.__("Check Updated!", "erp"));
                })
                .catch((error) => {
                    throw error;
                })
        ...
        createCheck(requestData) {
            window.axios
                ...
                .then((res) => {
                    this.showAlert("success", this.$func.__("Check Created!", "erp"));
                })
                .catch((error) => {
                    throw error;
                })
        ...
        validateForm() {
            ...
            if (
                ...
                this.form_errors.push(this.$func.__("Pay to is required.", "erp"));
            }

            if (!this.basic_fields.check_no) {
                this.form_errors.push(this.$func.__("Check No is required.", "erp"));
            }
            ...
            if (
                ...
                this.form_errors.push(
                    this.$func.__("Transaction Account is required.", "erp")
                );
            }
...
.check-create .col--account {
    width: 300px;
}

.check-create .col--particulars {
    width: 400px;
}
</style>
