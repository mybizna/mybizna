                        ...
                        >
                            <thead>
                                <tr class="inline-edit-row">
                                    ...
                                    <th>{{ this.$func.__("Bill No", "erp") }}</th>
...
.paybill-single .wperp-modal-footer {
    border-top: 1px solid #e2e2e2;
}
.paybill-single .wperp-modal-header {
    border-bottom: 1px solid #e2e2e2;
}
.paybill-single .wperp-form-field,
.paybill-single .wperp-form-field input:not(.wperp-btn) {
