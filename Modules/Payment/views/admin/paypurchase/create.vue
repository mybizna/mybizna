<template>
    <div class="mybizna-container pay-purchase-create">
            ...
            >
                <div class="mybizna-panel-body">
                    ...
                    <div class="mybizna-row">
                        ...
                        <check-fields
                            v-if="
                                basic_fields.trn_by.id === paymentMethods.check
                            "
                ...
                <div class="table-container">
                    <table class="mybizna-table mybizna-form-table">
                        ...
                        <tbody>
                            <tr
                                :key="key"
                                v-for="(item, key) in pay_purchases"
...
export default {
    ...
    data() {
        return {
            basic_fields: {
                ...
                trn_ref: "",
                payment_date:
                    erp_acct_var.current_date /* global erp_acct_var */,
                deposit_to: "",
                billing_address: "",
    ...
    methods: {
        ...
        getDuePurchases() {
            ...
            window.axios
                .get(`/purchases/due/${this.basic_fields.vendor.id}`)
                .then((response) => {
        ...
        SubmitForPayment() {
            ...
            window.axios
                ...
                .then((res) => {
                    this.showAlert(
                        "success",
                        window.$func.__("Pay Purchase Created!", "erp")
                    );
                ...
                .catch((error) => {
                    this.showAlert("error", window.$func.__("Something went wrong!", "erp"));
                    throw error;
                });
        },
...
<style >
.pay-purchase-create .dropdown {
    width: 100%;
}

.pay-purchase-create .col--amount {
    width: 200px;
}
</style>
