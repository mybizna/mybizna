            ...
            <div class="table-container">
                <table class="wperp-table wperp-form-table">
                    ...
                    <tr class="inline-edit-row">
                        <th scope="col" class="col--id">{{ __('Bill No', 'erp') }}</th>
                    ...
                    <tbody>
                    <tr :key="key" v-for="(pay_bill,key) in pay_bills" class="inline-edit-row">
                        <td scope="row" class="col--id">#{{pay_bill.voucher_no}}</td>
...
export default {
    ...
    methods: {
        ...
        getDueBills() {
            ...
            window.axios.get(`/bills/due/${peopleId}`).then((response) => {
