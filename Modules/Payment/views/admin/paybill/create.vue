            ...
            <div class="mybizna-row mybizna-between-xs">
                <div class="mybizna-col">
                    <h2 class="content-header__title">
                        {{ window.$func.__("New Bill Payment", "erp") }}
                    </h2>
                </div>
            </div>
        </div>
                ...
                <div class="table-container">
                    <table class="mybizna-table mybizna-form-table">
                        ...
                        <tbody>
                            <tr
                                :key="key"
                                v-for="(pay_bill, key) in pay_bills"
    ...
    data() {
        return {
            ...
            createButtons: [
                ...
                {
                    id: "new_create",
                    text: window.$func.__("Save and New", "erp"),
                },
        ...
        SubmitForPayment() {
            ...
            window.axios
                ...
                .then((res) => {
                    this.showAlert(
                        "success",
                        window.$func.__("Pay-Bill Created!", "erp")
                    );
                ...
                .catch((error) => {
                    this.showAlert(
                        "error",
                        window.$func.__("Something went wrong!", "erp")
                    );
                    throw error;
                })
                .then(() => {
...
<style>
.pay-bill-create input[type="text"] {
    width: 90%;
}

.pay-bill-create .dropdown {
    width: 100%;
}

.pay-bill-create .col--amount {
    width: 200px;
}
</style>
